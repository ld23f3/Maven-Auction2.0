 ...
 * @throws IOException 
   ...
   public String AddGoods(@RequestParam("file") MultipartFile[] file,HttpServletRequest req,HttpSession session,HttpServletResponse res) throws IOException {
 ...
 */
   private List<String> saveFile(HttpServletRequest request,
           MultipartFile file, List<String> list,int goods_id ) {
       // 判断文件是否为空
       if (!file.isEmpty()) {
           try {
