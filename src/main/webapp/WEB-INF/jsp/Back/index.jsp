...
<![endif]-->
<title>Maven-Auction v2.0</title>
<meta name="keywords"
	content="Maven-Auction v2.0,乔治拍卖后台系统">
<meta name="description"
	content="Maven-Auction v2.0">
</head>
<body>
		...
		<div class="navbar navbar-fixed-top">
			<div class="container-fluid cl">
				<a class="logo navbar-logo f-l mr-10 hidden-xs"
					href="${pageContext.request.contextPath}/manage/index.html">Maven-Auction</a> <a
					class="logo navbar-logo-m f-l mr-10 visible-xs"
					href="${pageContext.request.contextPath}/manage/index.html">J-jo</a> <span
					class="logo navbar-slogan f-l mr-10 hidden-xs">v2.0</span> <a
	...
	<aside class="Hui-aside">
		<div class="menu_dropdown bk_2">
			<dl id="menu-article" hidden="hidden">
				<dt>
			...
			<dl id="menu-comments" hidden="hidden">
				<dt>
			...
			<dl id="menu-member">
				...
				<dd>
					<ul>
						...
						<li hidden="hidden"><a data-href="member-scoreoperation.html"
							data-title="积分管理" href="javascript:;">积分管理</a></li>
						<li hidden="hidden"><a data-href="member-record-browse.html"
							data-title="浏览记录" href="javascript:void(0)">浏览记录</a></li>
						<li hidden="hidden"><a
							data-href="member-record-download.html" data-title="下载记录"
							href="javascript:void(0)">下载记录</a></li>
						<li hidden="hidden"><a data-href="member-record-share.html"
							data-title="分享记录" href="javascript:void(0)">分享记录</a></li>
					</ul>
				</dd>
			</dl>
			<dl id="menu-admin">
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/static/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
	<script type="text/javascript">
		$(function() {
