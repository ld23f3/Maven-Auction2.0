...
<body>
				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav ">
							<li class=" active"><a
								href="${pageContext.request.contextPath}/api/query"
								class="hyper "><span>首页</span></a></li>
	...
	<div class="banner-bootom-w3-agileits"></div>
	<div class="top-products">
		<div class="container">
			<h3>Top Products ${size}</h3>
			<div class="sap_tabs">
				<div id="horizontalTab">
					<ul class="resp-tabs-list">

						<!--点击类型-->
						<li class="resp-tab-item"><span><a href="paper.html">字画</a></span></li>
						<li class="resp-tab-item"><span><a href="ceramics.html">陶瓷</a></span></li>
						<li class="resp-tab-item"><span><a href="jade.html">玉石</a></span></li>
						<li class="resp-tab-item"><span><a href="sundry.html">杂项</a></span></li>
					</ul>
					<div class="clearfix"></div>
												...
												<div class="p-mask">
													<form action="#" method="post">
														<input type="hidden" name="cmd" value="_cart" /> <input
															...
															type="hidden" name="w3ls1_item" value="" /> <input
															type="hidden" name="amount"
															value="${good.goods_minprice}" />
														<button type="button" class="w3ls-cart pw3ls-cart">
															<i class="fa fa-cart-plus" aria-hidden="true"></i> 查看商品
														</button>
													</form>
												</div>
	...
	<div class="footer">
		<div class="container">
			...
			<p class="copy-right">
				...
				Templates <a href="${pageContext.request.contextPath}/api/query"
					target="_blank" title="喬治拍卖">喬治拍卖</a> >网页模板</a>
			</p>
		</div>
	</div>
	<!-- cart-js -->
	...
	<script
		src="${pageContext.request.contextPath}/static/Assets/js/easyResponsiveTabs.js"
