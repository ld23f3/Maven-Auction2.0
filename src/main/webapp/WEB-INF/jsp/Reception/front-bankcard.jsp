	...
	<div class="container">
		...
		<div class="col-md-9 col-sm-9 contact-right">
			<div class="table-responsive">
				...
				<div class="main-content card-index">
					<div class="fe-global-page-title fe-global-page-title-balance">
						<h3><span class="fe-global-page-title-bar"></span><span>银行卡</span></h3>
						<span class="fe-global-page-title-split"></span>
						<span class="fe-global-page-title-sub">我的银行卡</span>
					</div>
					<div class="clearfix card-content" data-role="card_wrap">
						<div class="card-bar" data-role="card_nav">
							<div class="card-list" data-role="card_list">
								<div class="card card-click" data-role="card_list_wrap" style="top: 0px;">
									<div class="card card-click" data-role="card_item">
										<div class="card-bank-logo">
											<span class="card-bank-img bind-card-bank-icon-original bind-bank-item bind-card-bank-icon-4003"></span>
										</div>
										<p>**** **** **** 1858</p>
										<span class="card-type">储蓄卡</span>
										<div class="easy-pay"></div>
									</div>
									<a class="add-card add-card-enable" href="add_bankcard" data-role="card_add"></a>
								</div>
							</div>
						</div>
						<div class="card-info" data-role="card_info">
							<em class="card-info-pointer" data-role="card_pointer" style="top: 45px;"></em>
							<p class="info-title">银行卡</p>
							<div class="card-info-list" data-role="card_info_list">
								<ul style data-role="card_info_item">
									<li><span>快捷支付</span><a href="javascript:void(0)" class="close-easypay" data-role="card_cancel_bind">解除绑定</a></li>
									<li><span>申请时间</span><span>2018年06月25日</span></li>
								</ul>
							</div>
							<div class="card-pwd" data-role="card_pwd" style="display: none;"></div>
						</div>
					</div>
				</div>				
