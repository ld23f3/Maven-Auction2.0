	...
	<div class="container">
		...
		<div class="col-md-9 col-sm-9 contact-right">
			<form action="addAddress" method="post">
				<input type="text" name="consignee_name" placeholder="真实姓名" required=" "><br />
				<input type="text" name="consignee_tel" placeholder="电话" required=" "><br />
				<input type="text" name="consignee_address" placeholder="省-市-县-详细门牌号" required=" "><br />
