		...
		<div class="main-agileits">
				<div class="form-w3agile">
					...
					<form action="#" method="post">
						<p>请输入卡号</p>
						<div class="key">
							<input  type="text"  name="bankcard"  required="" placeholder="bankcard">
							<div class="clearfix"></div>
						</div>
						<!--
                        	作者：offline
                        	时间：2018-06-25
                        	描述：真实姓名最好固定为用户真实姓名，不可更改
                        -->
                        <p>开卡人姓名</p>
						<div class="key">
							<input  type="text"  name="realname"  required="" placeholder="realname">
							<div class="clearfix"></div>
						</div>
						<p>请输入银行保留电话</p>
						<div class="key">
						...
						<p>请输入支付密码</p>
						<div class="key">
							<input  type="text"  name="bankcardPwd"  required=""  placeholder="bankcardPwd">
							<div class="clearfix"></div>
						</div>
				...
				<div class="forg">
					...
					<a href="bankcard" class="forg-right">取消</a>
				<div class="clearfix"></div>
				</div>
