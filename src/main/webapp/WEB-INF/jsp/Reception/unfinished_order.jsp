...
<!-- css -->
<link href="${pageContext.request.contextPath}/static/Assest/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
<link rel="stylesheet" href="${pageContext.request.contextPath}/static/Assest/css/style.css" type="text/css" media="all" />
<link rel="stylesheet" href="${pageContext.request.contextPath}/static/Assest/css/font-awesome.min.css" type="text/css" media="all" />
<!--// css -->
<!-- font -->
<link href="http://fonts.googleapis.com/css?family=Source+Sans+Pro" rel="stylesheet">
<link href='http://fonts.googleapis.com/css?family=Open+Sans:400,300,300italic,400italic,600,600italic,700,700italic,800,800italic' rel='stylesheet' type='text/css'>
<!-- //font -->
<script src="${pageContext.request.contextPath}/static/Assest/js/jquery-1.11.1.min.js"></script>
<script src="${pageContext.request.contextPath}/static/Assest/js/bootstrap.js"></script>
</head>
<body>
<div class="header-top-w3layouts">
	<div class="container">
		<div class="col-md-6 logo-w3">
			<a href="${pageContext.request.contextPath}/api/query"><img src="${pageContext.request.contextPath}/static/Assest/images/logo2.png" alt=" " /><h1>喬治拍卖</h1></a>
		</div>
								...
								<ul class="dropdown-menu multi">
									<div class="row">
										...
										<div class="col-sm-4 w3l">
											<a href=""><img src="${pageContext.request.contextPath}/static/Assest/images/menu1.jpg" class="img-responsive" alt=""></a>
										</div>
										<div class="clearfix"></div>
									</div>	
								</ul>
						...
						<li class="dropdown">
								...
								<ul class="dropdown-menu multi multi1">
									<div class="row">
										...
										<div class="col-sm-4 w3l">
											<a href=""><img src="${pageContext.request.contextPath}/static/Assest/images/menu2.jpg" class="img-responsive" alt=""></a>
										</div>
										<div class="clearfix"></div>
									</div>	
								</ul>
						...
						<li class="dropdown">
								...
								<ul class="dropdown-menu multi multi1">
									<div class="row">
										...
										<div class="col-sm-4 w3l">
											<a href=""><img src="${pageContext.request.contextPath}/static/Assest/images/menu3.jpg" class="img-responsive" alt=""></a>
										</div>
										<div class="clearfix"></div>
									</div>	
								</ul>
						...
						<li class="dropdown">
								...
								<ul class="dropdown-menu multi multi1">
									<div class="row">
										...
										<div class="col-sm-4 w3l">
											<a href=""><img src="${pageContext.request.contextPath}/static/Assest/images/menu4.jpg" class="img-responsive" alt=""></a>
										</div>
										<div class="clearfix"></div>
									</div>	
								</ul>
								...
								<table class="table table-striped">
									...
									<tbody>
										<tr>
											...
											<td>${orders.goodstype_desc}</td>
											<td>${orders.consignee_address}</td>
											<td>${orders.goods_minprice}</td>
											<td>${orders.order_state}</td>
											<td>${orders.order_date}</td>
											<td>${orders.senddate}</td>
											<td><a href="javascript:void(0)" onclick="updArticle(${orders.order_id})">收货</a></td>
...
<div class="footer">
	<div class="container">
		...
		<a href="${pageContext.request.contextPath}/api/query"><img src="${pageContext.request.contextPath}/static/Assest/images/logo2.png" alt=" " /><h3>喬治拍卖</span></h3></a>
		<ul>
			<li>地址：厦门市观日路2号</li>
			<li>邮编：350000</li>
	...
	<!-- cart-js -->
	<script src="${pageContext.request.contextPath}/static/Assest/js/minicart.js"></script>
	<script>
        w3ls1.render();
