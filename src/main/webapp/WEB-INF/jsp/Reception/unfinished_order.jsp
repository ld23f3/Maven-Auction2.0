...
<div class="header-top-w3layouts">
	<div class="container">
		<div class="col-md-6 logo-w3">
			<a href="index.html"><img src="${pageContext.request.contextPath}/static/Assest/images/logo2.png" alt=" " /><h1>喬治拍卖</h1></a>
		</div>
...
<div class="footer">
	<div class="container">
		...
		<a href="index.html"><img src="${pageContext.request.contextPath}/static/Assest/images/logo2.png" alt=" " /><h3>喬治拍卖</span></h3></a>
		<ul>
			<li>地址：厦门市观日路2号</li>
			<li>邮编：350000</li>
