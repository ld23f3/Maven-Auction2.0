	...
	<div class="container">
		...
		<div class="col-md-3 col-sm-3 contact-left">
			...
			<div class="dresses_img_hover">
				<img src="${pageContext.request.contextPath}/static/Assets/images/offer.jpg" alt=" " class="img-responsive" />					
			</div>
		...
		<div class="col-md-9 col-sm-9 contact-right">
			<form action="contact" method="post">
				<input type="text" name="user_realname" placeholder="真实姓名" required=" "></br>
				<input type="text" name="user_cardid" placeholder="身份证号" required=" "></br>
				<input type="text" name="user_address" placeholder="用户地址" required=" "></br>
