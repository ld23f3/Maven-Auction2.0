		...
		<div class="container">
			...
			<div class="col-md-4 search-agileinfo">
				<form action="#" method="post">
					<input type="search" name="search" placeholder="搜索您想要的拍卖品"
						required="">
			...
			<div class="col-md-9 col-sm-9 contact-right">
				<form action="contact" method="post">
					<input type="text" name="user_realname" placeholder="真实姓名"
						required=" "></br> <input type="text" name="user_cardid"
						placeholder="身份证号" required=" "></br> <input type="text"
						name="user_address" placeholder="用户地址" required=" "></br> <input
						type="submit" value="上传信息">
				</form>
			</div>
		</div>
	</div>
